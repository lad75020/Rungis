...
**Branch**: `feature/time-machine-analytics-reporting` | **Date**: 2026-06-19 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `/specs/009-analytics-reporting/spec.md`

## Summary

Document and verify admin and vendor reporting workflows covering activated order trends, sales by category, sales by client, and monthly summaries.
...
**Scale/Scope**: One Time Machine slice focused on Analytics and Reporting
...
```text
specs/009-analytics-reporting/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
├── quickstart.md
├── contracts/analytics-reporting.openapi.yml
└── tasks.md

backend/src/routes/modules/management.js
backend/src/models/validated-order.model.js
backend/src/models/bill.model.js
frontend/src/app/pages/statistics-page.component.ts
frontend/src/app/pages/statistics-page.component.html
frontend/src/app/app.view-models.ts
...
- [contracts/analytics-reporting.openapi.yml](./contracts/analytics-reporting.openapi.yml) documents the relevant external surface.
